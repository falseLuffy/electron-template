<template>
    <div class="chart-box" ref="chartBox">
        <svg width="524px" :height="height" :viewBox="`0 0 524 ${height}`" version="1.1"
            ...
            <defs>
                ...
                <polygon :id=" `path-${height}`"
                         :points="`0 0 238 0 270 32 524 32 524 ${height} 484 ${height} 468 ${height - 8} 56 ${height - 8} 40 ${height} 0 ${height}`"></polygon>
                <polygon id="path-3" points="0.5 0.5 0.5 24.5 64.5 24.5 64.5 0.5 0.5 0.5"></polygon>
                <filter x="-1.9%" y="-3.2%" width="103.8%" height="106.5%" filterUnits="objectBoundingBox"
                        id="filter-3">
                ...
                <filter x="-12.7%" y="-40.0%" width="125.4%" height="180.0%" filterUnits="objectBoundingBox"
                        id="filter-7">
                    <feGaussianBlur stdDeviation="10" in="SourceAlpha" result="shadowBlurInner1"></feGaussianBlur>
                    <feOffset dx="0" dy="0" in="shadowBlurInner1" result="shadowOffsetInner1"></feOffset>
                    <feComposite in="shadowOffsetInner1" in2="SourceAlpha" operator="arithmetic" k2="-1" k3="1"
            ...
            <g id="页面1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g>
                    ...
                    <g id="tab-wrap" transform="translate(253, 0)">
                        <g id="tab1" transform="translate(0, 0)" @click="toggle('clue')" style="cursor: pointer;">
                            <template v-if="currentTab === 'clue'">
                                <g id="矩形">
                                    ...
                                    <use fill="black" fill-opacity="1" filter="url(#filter-7)"
                                         xlink:href="#path-6"></use>
                                ...
                                <text id="线索" font-family="PingFangSC-Semibold, PingFang SC" font-size="16"
                                      font-weight="500"
                                      fill="#FFFFFF">
                        ...
                        <g id="tab2" transform="translate(78, 0)" @click="toggle('filing')" style="cursor: pointer;">
                            <template v-if="currentTab === 'filing'">
                                <g>
                                    ...
                                    <use fill="black" fill-opacity="1" filter="url(#filter-7)"
                                         xlink:href="#path-3"></use>
                                    <path d="M0.5,0.5 L0.5,24.5 L64.5,24.5 L64.5,0.5 L0.5,0.5 Z" id="矩形备份-12"
                                          stroke-opacity="0.7"
                                          stroke="#51A3FF" fill-opacity="0.8"></path>
                                </g>
                                <text id="立案" font-family="PingFangSC-Regular, PingFang SC" font-size="16"
                                      font-weight="normal"
                                      fill="#FFFFFF">
                        ...
                        <g id="tab3" transform="translate(142, 0)" @click="toggle('beforeSuit')"
                           style="cursor: pointer;">
                            <template v-if="currentTab === 'beforeSuit'">
                                <g>
                                    ...
                                    <use fill="black" fill-opacity="1" filter="url(#filter-7)"
                                         xlink:href="#path-3"></use>
                                    <path d="M0.5,0.5 L0.5,24.5 L64.5,24.5 L64.5,0.5 L0.5,0.5 Z" id="矩形备份-7"
                                          stroke-opacity="0.7"
                                          stroke="#51A3FF" fill-opacity="0.8" fill="url(#linearGradient-7)"></path>
                                </g>
                                <text id="诉前" fill="#fff">
