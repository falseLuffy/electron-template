<template>
  <div class="irregularity" :style="`height: ${Height + 1}px`">
    <svg :width="`${Width + 1}px`" :height="`${Height +1}px`" :viewBox="`0 0 ${Width + 1} ${Height + 1}`" version="1.1"
      ...
      <defs>
        ...
        <filter x="-8.3%" y="-7.9%" width="114.1%" height="115.7%" filterUnits="objectBoundingBox" :id="`filter${id}`">
      ...
      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <g>
          ...
          <foreignObject :x="start + interval + 'px'" y="0" :width="Width - start - interval + a + 'px'" height="100%">
        ...
        <g>
          ...
          <use fill="black" fill-opacity="1" :filter="`url(#filter${id})`" :xlink:href="`#irregularityList${id}`"></use>
        </g>
      </g>
    </svg>
  </div>
