<template>
    <div class="data-visual" ref="dataContainer">
        <div class="header">
            <svg class="back" @click="$router.push({path: '/'})" width="75px" height="40px" viewBox="0 0 75 40"
                 version="1.1"
                    ...
                    <g id="公益诉讼态势分析备份-19" transform="translate(-32.000000, -28.000000)">
                        <g id="编组-23" transform="translate(32.000000, 28.000000)">
                            <g id="出生年月">
                                ...
                                <path d="M11.7928932,0.5 L0.5,0.5 L0.5,11.7928932 L11.7928932,0.5 Z" id="路径-3"
                                      stroke-opacity="0.7"
                                ...
                                <path d="M73.7928932,27.5 L62.5,27.5 L62.5,38.7928932 L73.7928932,27.5 Z" id="路径-3备份"
                                      stroke-opacity="0.7" stroke="#51A3FF" fill-opacity="0.3"
                                      fill="url(#linearGradient-back)"
                ...
                <g id="页面1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="公益诉讼态势分析备份-19" transform="translate(-475.000000, -1.000000)">
                        <g id="编组-24" transform="translate(480.000000, 1.000000)">
                            ...
                            <rect id="矩形" stroke="#9BFFFF" fill="#9BFFFF" x="380.5" y="56.5" width="199" height="2"
                                  rx="1"></rect>
                            <rect id="矩形备份-6" stroke="#9BFFFF" fill="#9BFFFF" x="368.5" y="56.5" width="2" height="2"
                                  rx="1"></rect>
                            <rect id="矩形备份-6" stroke="#9BFFFF" fill="#9BFFFF" x="589.5" y="56.5" width="2" height="2"
                                  rx="1"></rect>
        ...
        <svg class="timer-picker-wrap" width="300px" height="40px" viewBox="0 0 300 40" version="1.1"
            ...
            <g id="南沙10-23" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <path d="M298.792893,27.5 L287.5,27.5 L287.5,38.7928932 L298.792893,27.5 Z" id="路径-3备份"
                      stroke-opacity="0.7"
        ...
        <div class="center">
            <div class="layout">
                    ...
                    <div style="height: 298px;margin: 24px 0 0;">
                        <chart-box title="领域分布" v-model="suitFieldDistribute.currentTab">
                            ...
                            <div class="radar-wrap" style="width: 100%; height: 100%">
                                <radar-chart
                                        :data="suitFieldDistribute.pool[suitFieldDistribute.currentTab] || []"></radar-chart>
                            </div>
                        </chart-box>
                    </div>
                </div>
                        ...
                        <div class="dataMap-descript">
                            <div class="description first">
                                <svg class="icon" width="50px" height="50px" viewBox="0 0 50 50" version="1.1"
                                    ...
                                    <desc>Created with Sketch.</desc>
                                    <g id="南沙10-23" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="公益诉讼态势分析备份-19" transform="translate(-638.000000, -173.000000)"
                                           fill-rule="nonzero">
                                            <g id="编组-22备份" transform="translate(623.000000, 151.000000)">
                                                <g id="线索" transform="translate(16.000000, 23.000000)">
                                                    <rect id="矩形" fill="#051944" x="0" y="0" width="48" height="48"
                                                          rx="4"></rect>
                                                    <path
                                ...
                                <div class="wrap">
                                    ...
                                    <div class="number">
                                        <NumberGrow v-if="noticeAndsuggestion.pool.clue_num"
                                                    :value="noticeAndsuggestion.pool.clue_num"></NumberGrow>
                            ...
                            <div class="description second">
                                <svg class="icon" width="66px" height="66px" viewBox="0 0 66 66" version="1.1"
                                     ...
                                     xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="南沙10-23" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="公益诉讼态势分析备份-19" transform="translate(-1076.000000, -234.000000)"
                                           fill-rule="nonzero">
                                            <g id="编组-22备份-3" transform="translate(1056.000000, 204.000000)">
                                                <g id="线索" transform="translate(21.000000, 31.000000)">
                                                    <rect id="矩形" fill="#051944" x="0" y="0" width="64" height="64"
                                                          rx="4"></rect>
                                                    <path
                                                    ...
                                                    <g id="立案信息" transform="translate(8.000000, 5.333333)">
                                                        <rect id="矩形" fill="#000000" opacity="0" x="0" y="0"
                                                              width="53.3333333"
                                ...
                                <div class="wrap">
                                    ...
                                    <div class="number">
                                        <NumberGrow v-if="noticeAndsuggestion.pool.filing_num"
                                                    :value="noticeAndsuggestion.pool.filing_num"></NumberGrow>
                            ...
                            <div class="description three">
                                <svg class="icon" width="50px" height="50px" viewBox="0 0 50 50" version="1.1"
                                     ...
                                     xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="页面1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="公益诉讼态势分析备份-19" transform="translate(-601.000000, -501.000000)"
                                           fill-rule="nonzero">
                                            <g id="编组-22备份-2" transform="translate(586.000000, 479.000000)">
                                                <g id="线索" transform="translate(16.000000, 23.000000)">
                                                    ...
                                                    <g id="法律诉讼" transform="translate(4.000000, 4.000000)">
                                                        <rect id="矩形" fill="#000000" opacity="0" x="0" y="0" width="40"
                                                              height="40"></rect>
                                                        <path
                                ...
                                <div class="wrap">
                                    ...
                                    <div class="number">
                                        <NumberGrow v-if="noticeAndsuggestion.pool.suit_num"
                                                    :value="noticeAndsuggestion.pool.suit_num"></NumberGrow>
                                            ...
                                            <g id="编组-18">
                                                <g id="编组-32">
                                                    ...
                                                    <g id="编组-6">
                                                        ...
                                                        <use id="蒙版" fill="#003070" opacity="0.7"
                                                             xlink:href="#path-1"></use>
                                                        <g opacity="0.502325149" style="mix-blend-mode: screen;"
                                                           mask="url(#mask-2)"
                                                           fill-opacity="0.2">
                                                    ...
                                                    <foreignObject class="node" x="0" y="0" width="100%" height="100%">
                                                        <div class="preSuit-wrap">
                                                            ...
                                                            <p class="word">
                                                                <number-grow
                                                                        v-if="noticeAndsuggestion.pool.announcement_num"
                                                                        :value="noticeAndsuggestion.pool.announcement_num | overflow"></number-grow>
                        ...
                        <handing-result title="办案成效" @change="handleClassChange">
                            <div style="margin: 0 20px; padding: 10px 0;height: 206px;overflow: auto">
                                <irregularityList :id="'aaa'+index" :type="!(index%2) ?'left': 'right'"
                                                  v-for="(item,index) in suitFieldDeal.pool[suitFieldDeal.currentTab]"
                                                  :data="item"
                ...
                <div class="layout-side-r">
                    ...
                    <div class="suggest-wrap" v-loading="suitSuggestion.loading"
                         element-loading-background="rgba(7,17,27,0.6)">
                        <chart-box-normal title="检查建议接受单位">
                            ...
                            <div style="height: 100%;overflow: auto;">
                                <div class="classic-table-wrap">
                                    ...
                                    <rateBarChart v-for="(item, index) in suitSuggestion.pool" :data="item.data"
                                                  :label="item.name"
                    ...
                    <div style="height: 296px;margin: 24px 0 0;" v-loading="courtTrial.loading"
                        ...
                        <chart-box title="法院审结情况" v-model="courtTrial.currentTab">
                            <div class="multi-pieChart-wrap" style="height: 100%">
                                <multiPieChart title="75%"
                                               :data="courtTrial.pool[courtTrial.currentTab]"></multiPieChart>
                            </div>
                        </chart-box>
                    </div>
                </div>
...
<script>
  ...
  import {getLaysuitType, getRegion} from '@/Api/api'

  import elementPressKey from '@/common/utils/elementPressKey'
  ...
  export default {
    ...
    mounted () {
      ...
      this.confirmInstance = this.$confirm('为了给您一个更好的展示效果，请选择全屏显示', '提示', {
    ...
    destroyed () {
      ...
      elementPressKey(document.body, 27)
    }
  }
</script>
